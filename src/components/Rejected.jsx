...
import "./Dash.css";
export default function Rejected({ data, type }) {
  const pendingReviews = data.filter((review) => { return review.Review_status === "Rejected" })
  ...
  return (
    <>
      ...
      {pendingReviews.map((review, key) => {
        return (
          <div key={key} className="card  text-center pending-bg-set my-3 bg-danger">
